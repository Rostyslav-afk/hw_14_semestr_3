...
const getUsersWithEyeColor = (users, color) => {
    const whatColor = users.filter(user => user.eyeColor === color);
    return whatColor
};
...
const getUsersWithGender = (users, gender) => {
    const whatGender = users.filter(user => user.gender === gender).map(user => user.name);
    return whatGender
};
...
const getUserWithEmail = (users, email) => {
    const wantedEmail = users.find(user => user.email === email);
    return wantedEmail;
};
